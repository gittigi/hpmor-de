...
ebook-convert $source_file $target_file --language de-DE --no-default-epub-cover --cover "ebook/tmp/title.jpg" --book-producer "Torben Menke" --level1-toc "//h:h1" --level2-toc "//h:h2" --level3-toc "//h:h3"
