...
# # insert some lines for overwriting envs and commands
...
# sed -i '12i\\\renewenvironment{playdialog}{}{}' $target_file
...
# sed -i '14i\\\renewcommand\{\\parsel}[1]{\\textcolor{parsel}{#1}}' $target_file
# sed -i '15i\\\renewcommand\{\\McGonagallWhiteBoard}[1]{\\begin{center}\\textcolor{McGonagallWhiteBoard}{#1}\\end{center}}' $target_file
# sed -i '16i\\\renewcommand\{\\headline}[1]{\\begin{center}\\textcolor{headline}{#1}\\end{center}}' $target_file
# sed -i '17i\\\renewcommand\{\\inlineheadline}[1]{\\textcolor{headline}{#1}}' $target_file
