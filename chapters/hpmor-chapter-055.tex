...
\emph{Nein!} dachte Harry verzweifelt. \emph{Nein, das ergibt keinen Sinn, wir wollten das perfekte Verbrechen begehen, das Auror hätte obliviiert werden können, der Korridor repariert, es war nicht zu spät, aber es wäre zu spät gewesen, wenn er gestorben wäre!}%
\translatorsnote{Obliviate—Gedächtniszauber, der Erinnerungen aus dem Gedächtnis einer Person löschen kann}
