...
\emph{Und bevor irgendwer sonst etwas sagen konnte, tönte Harry:}

\emph{"Nur ein Scherz! RAVENCLAW!"}

\emph{Danach herrschte für einen kurzen Moment Stille, das Geräusch denkender Menschen und dann begann das Gemurmel und die Gespräche schwollen rasch zu einem Rauschen an.}

\emph{Harry drehte sich zu Professor Quirrell um, sie beide mussten reden -}

\emph{Quirrell war zusammen gesackt und trottete zu seinem Stuhl zurück.}

\emph{Nein. Inakzeptabel. Sie mussten} \emph{\emph{wirklich}} \emph{reden. Schluss mit dem Zombie-Getue, Professor Quirrell würde wahrscheinlich aufwachen, wenn Harry ihn ein paar mal anstupste. Harry schritt voran -}

\emph{FALSCH\\ NICHT\\ SCHLECHTE IDEE}

\emph{Harry schwankte und stoppte abrupt, fühlte sich schwindlig.}

\emph{Und dann ging ein Schwarm von Ravenclaws auf ihn nieder und die Debatten begannen.}
