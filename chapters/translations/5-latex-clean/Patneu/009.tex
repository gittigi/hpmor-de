...
* Natürlich dürft ihr auch gerne noch mitraten, obwohl ich nicht weiß, wie viel Zeit die Leser der englischen Fassung hatten und ich von daher nicht versprechen kann, euch auch nur annähernd so viel Zeit einzuräumen.\\ ** Eine außerirdische Spezies aus dem Roman \emph{Im Reich der Dirdir,} dem dritten Band des \emph{Tschai-Zyklus.}\\ *** engl.: \emph{Puppeteers}, auch \emph{Pierson's Puppeteers,} eine außerirdische Spezies aus den \emph{Known} \emph{Space}-Romanen von Larry Niven, angefangen mit \emph{Der schwebende Wald.}\\ **** engl.: \emph{Oh, I'm the Sorting Hat and I'm okay, I sleep all year and I work one day…}
