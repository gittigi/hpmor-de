...
\hfill\break 1.000 REZENSIONEN IN 26 TAGEN, WUUHUU, SUPA LEISTUNG! 30 TAGE 1.189-REZENSIONEN-KOMBO UND STEIGEND! YEAH! IHR LEUTE SEID DIE BESTEN! DAS IST SPARTAAAAA!
...
\emph{* Natürlich dürft ihr auch gerne noch mitraten, obwohl ich nicht weiß, wie viel Zeit die Leser der englischen Fassung hatten und ich von daher nicht versprechen kann, euch auch nur annähernd so viel Zeit einzuräumen.}\\ \emph{** Eine außerirdische Spezies aus dem Roman} \emph{\emph{Im Reich der Dirdir,}} \emph{dem dritten Band des} \emph{\emph{Tschai-Zyklus.}}\\ \emph{*** engl.:} \emph{\emph{Puppeteers}, auch} \emph{\emph{Pierson's Puppeteers,}} \emph{eine außerirdische Spezies aus den} \emph{\emph{Known}} \emph{\emph{Space}-Romanen von Larry Niven, angefangen mit} \emph{\emph{Der schwebende Wald.}}\\ \emph{**** engl.:} \emph{Oh, I'm the Sorting Hat and I'm okay, I sleep all year and I work one day...}
