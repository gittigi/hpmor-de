...
* engl.: \emph{A History of Magic}\\ ** engl.: \emph{Occlumency: The Hidden Arte;} es schien mir als solle der Titel mit dem zusätzlichen "e" bewusst altertümlich klingen, daher habe ich hierfür eine laut Wiktionary althochdeutsche Form des Wortes \emph{Kunst} verwendet (vielleicht schon etwas zu alt).\\ *** Unter \emph{star lifting} versteht man verschiedene Technologien, die eine fortschrittliche raumfahrende Zivilisation nutzen könnte, um einem Stern bedeutende Teile seiner Masse zu entziehen, etwa als Quelle von Rohmaterialien.
