...
\hypertarget{erwiderung}{% \section{7. Erwiderung}\label{erwiderung}}
...
\textbf{Seltsaft:}\\ Im Original heißt das Getränk \emph{Comed-Tea} -- was fast wie \emph{Comedy} klingt. Ist die Übersetzung dieses Wortspiels geglückt?

\textbf{Elevator Pitch:}\\ (aus dem Englischen: "elevator" = Fahrstuhl, "pitch" = Verkaufsgespräch)\\ Stell dir vor, du arbeitest in einer großen Firma und brütest seit langem über einer großen Idee. Eines Tages stehst du zufällig mit dem Firmenchef im Aufzug und hast wenige Stockwerke Zeit, ihn von deiner Idee zu überzeugen …
