...
\hfill\break \emph{Es gab mysteriöse Fragen, doch eine mysteriöse Antwort war ein Widerspruch in sich.}\\
...
Sie geben mir eine ZEITMASCHINE, um meine EINSCHLAFSTÖRUNGEN zu behandeln.

SIE \textbf{GEBEN MIR EINE ZEITMASCHINE UM \textbf{MEINE EINSCHLAFSTÖRUNGEN ZU BEHANDELN.}}
...
\emph{Sagen Sie, Professor McGonagall, wussten Sie, dass zeit-verkehrte normale Materie genau wie Antimaterie aussieht? Nun, ja, so ist es! Wussten Sie, dass ein Kilogramm Antimaterie, wenn es auf ein Kilogramm Materie trifft, mit der Energie von 43 Millionen Tonnen TNT explodiert? Ist Ihnen klar, dass ich selbst 41 Kilogramm wiege und dass die folgende Explosion EINEN RIESIGEN RAUCHENDEN KRATER HINTERLASSEN WÜRDE, WO VORHER SCHOTTLAND WAR?}

„Entschuldigen Sie“, schaffte Harry zu sagen, „aber das klingt wirklich, wirklich, \emph{wirklich, WIRKLICH GEFÄHRLICH!“} Harrys Stimme wurde nicht ganz zu einem Kreischen; er konnte unmöglich laut genug schreien, um dieser Situation gerecht zu werden, also würde er es gar nicht erst versuchen.
...
„Und ich will ja wirklich nicht \emph{RUMDISKUTIEREN“} -- Harry versuchte angestrengt, seine hysterische Stimme etwas zu senken -- „aber hat irgendjemand mal darüber nachgedacht, was es \emph{BEDEUTET,} sechs Stunden durch die Zeit zurückzureisen und irgendetwas zu ändern, wodurch so ziemlich \emph{ALLE BETROFFENEN PERSONEN GELÖSCHT} und \emph{DURCH ANDERE VERSIONEN VON} --“
...
\emph{„DAS MACHT DIE SACHE NICHT BESSER! HABT IHR LEUTE JEMALS VON DEM ANTHROPISCHEN PRINZIP GEHÖRT? UND WAS FÜR EIN IDIOT HAT ZUM ERSTEN MAL EINES VON DIESEN DINGERN GEBAUT?“}
...
\emph{Dies ist der Unsichtbarkeitsumhang von Ignotus Peverell, der seinen Nachkommen, den Potters, vererbt wurde. Im Gegensatz zu anderen Umhängen oder Zaubersprüchen hat er die Macht, dich zu \uline{verstecken} und nicht nur unsichtbar zu machen. Dein Vater lieh ihn mir kurz vor seinem Tod für Nachforschungen aus und ich gebe zu, dass er mir über die Jahre gute Dienste erwiesen hat.}
...
\emph{Ach, gäb' uns höh're Macht das Glück\\ Uns selbst zu sehen mit andrem Blick.\\ Dies hielt' von Fehlern uns zurück\\ Und Vorurteilen.}
...
\textbf{Wussten Sie, dass zeit-verkehrte normale Materie genau wie Antimaterie aussieht?}\\ Harry bezieht sich auf das \href{https://de.\%20wikipedia.\%20org/wiki/CPT-Theorem“\%20target=}{CPT-Theorem}.

\textbf{Anthropisches Prinzip:}\\ Das Universum ist nur deswegen beobachtbar, weil es alle Eigenschaften hat, die zur Existenz eines Beobachters notwendig sind.

Sich zu wundern, \emph{was für ein bemerkenswerter Zufall} es doch sei, dass die Naturkonstanten in unserem Universum sich genau so verhalten, dass intelligentes Leben möglich ist (obwohl es doch bei fast allen anderen Kombinationen von Naturkonstanten nicht existieren würde), ist also ebenso unsinnig, wie sich zu wundern, \emph{was für ein bemerkenswerter Zufall} es doch sei, dass man in einem Krankenhaus zur Welt gekommen ist (obwohl an fast allen Orten auf der Erdoberfläche, an denen man ja theoretisch zur Welt kommen könnte, kein Krankenhaus ist).\\ Der \href{https://de.\%20wikipedia.\%20org/wiki/Anthropisches_Prinzip“\%20target=}{entsprechende Wikipedia-Artikel} ist sehr interessant, wenn man sich für Details dieser Argumentation interessiert.

\textbf{Ach gäb' uns höh're Macht das Glück {[}…{]}}\\ Aus dem Gedicht „An eine Laus“ vom schottischen Nationaldichter Robert Burns. Eine gemeinfreie Übersetzung habe ich nicht gefunden, diese ist daher von mir. (Gedichte finde ich deutlich schwerer zu übersetzen als Fließtext, aber glücklicherweise hatte ich in den Weihnachtsferien eine kreative Phase, wo ich drei verschiedene Übersetzungen dieses Vierzeilers innerhalb von 10 Minuten geschrieben habe…)

Im Original:\\ \emph{Oh wad some power the giftie gie us\\ To see oursel's as others see us!\\ It wad frae monie a blunder free us,\\ And foolish notion~--}
