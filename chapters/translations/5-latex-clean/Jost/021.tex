...
Da bin ich wieder. Tut mir Leid, dass es so lange gedauert hat.

Die gute Neuigkeit: Ich habe inzwischen meine Masterarbeit abgegeben und verteidigt, \emph{sollte} nun also mehr Zeit haben. Übrigens steht in meinem Profil jeweils, wie viele Seiten vom nächsten Kapitel ich schon übersetzt habe; vielleicht hilft das auch, die Wartezeit etwas zu verkürzen~…
...
Euer Sohn, Harry James Potter-Evans-Verres

* * *

\textbf{Starlifting:} Sammelbegriff für verschiedene Techniken, mithilfe derer eine technologisch weit fortgeschrittene Zivilisation Material aus Sternen entfernen und für andere Zwecke verwenden könnte. (Siehe \href{https://en.wikipedia.org/wiki/Star_lifting}{englische Wikipedia}.)

Und im nächsten Kapitel:

„\emph{Im Ernst?} Die Längen der o-, e- und i-Laute in \emph{Oogely Boogely} müssen \emph{tatsächlich} im Verhältnis 3 zu 1 zu 2 stehen, sonst leuchtet die Fledermaus nicht? \emph{Warum? Warum? Um alles in der Welt, warum?“}
