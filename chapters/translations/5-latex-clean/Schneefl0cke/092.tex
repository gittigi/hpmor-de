...
\emph{Wie war das noch mal Slytherin? Du sagtest, dass nichts klappen würde? Das Menschen sich nicht ändern werden?} sagte Hufflepuff.\\ Etwas in Harry brach, so dass er all seine Kraft aufwenden musste, um sich zusammenzureißen.
...
\textbf{\emph{NEIN}}\emph{,} sagte der ganze Rest von ihm, jeder Teil seines Verstandes in einstimmiger Übereinstimmung, Wärme und Kälte und ein verborgener Ort aus Stahl.\\ \textbf{\emph{Niemals, niemals, für immer.}}
