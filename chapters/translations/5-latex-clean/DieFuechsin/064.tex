...
\hypertarget{omake-akten-alternative-parallelen}{% \section{32. Omake Akten, Alternative Parallelen}\label{omake-akten-alternative-parallelen}}
...
\emph{\emph{Hast du erwartet, dass ich einfach dastehe und dich ausreden lasse?}}
...
\emph{\emph{Und} \emph{die} \emph{Wahl ist mein Blut}}
...
Du sollst nicht gerächt werden, es sei denn, dass du schwörst:
...
(Dank an \textbf{dsummerstay}, der mich daran erinnert hat, dies zu posten)
