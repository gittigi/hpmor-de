...
„Ich würde sagen, das ist eine Teufelsschlingenpflanze und sie könnte sich vor Licht oder Hitze zurückziehen. Also könnte ein Erstklässler vielleicht \emph{Lumos} benutzen? Heute würde ich \emph{Inflammare} verwenden, aber ich habe diesen Zauberspruch erst im Mai gelernt.“
...
„\parsel{Ich habe Sie noch nicht verraten},“ zischte Harry.
...
\emph{Von Dumbledore für Erstklässler eingerichtet}, erinnerte sich Harry, \emph{\emph{wird} es sicher sein}, und er ging über das zerstörte Schachbrett, legte seine Hand auf die Klinke der Tür und drückte sie nach innen.
