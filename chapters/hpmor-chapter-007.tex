...
\translatorsnote{engl. \emph{Elevator Pitch}; \emph{elevator} = \emph{Fahrstuhl}, \emph{pitch} = \emph{Verkaufsgespräch}\\Stell dir vor, du arbeitest in einer großen Firma und brütest seit langem über einer großen Idee. Eines Tages stehst du zufällig mit dem Firmenchef im Aufzug und hast wenige Stockwerke Zeit, ihn von deiner Idee zu überzeugen.}
