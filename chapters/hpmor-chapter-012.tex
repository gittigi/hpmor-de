...
Genau genommen hatte der Comed-Tea die Quibblerschlagzeile über ihn und Draco nicht einfach \emph{erscheinen} lassen. Draco hatte es so erklärt, als ob es alles…einfach so passiert ist. Als ob der Comed-Tea die \emph{Geschichte so verändert, dass alles passt}.
